    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }} edges={['top', 'bottom']}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 70, paddingHorizontal: 24, backgroundColor: '#fff', elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 28 }}>
          <TouchableOpacity onPress={openModal}>
            <Text style={{ color: '#6b7280', fontSize: 18 }}>Iniciar Sesión</Text>
          </TouchableOpacity>
      ...
      >
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16 }}>
          <Image source={require('../../assets/CoPiloto-logo-1.png')} style={{ width: 288, height: 120 }} resizeMode="contain" />
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  disabled={loading}
                  className={`bg-blue-950 py-3 rounded items-center mx-8 mt-5 ${loading ? 'opacity-60' : ''}`}
                >
                ...
                <TouchableOpacity
                  ...
                  className="bg-white border border-gray-200 py-3 rounded-lg items-center mx-8 mt-3 flex-row justify-center gap-3"
                ...
                >
                  ...
                  <Text className="text-gray-700 text-lg">Continuar con Google</Text>
                </TouchableOpacity>

                {/* Guest */}
                <TouchableOpacity
                  onPress={handleGuest}
                  className="bg-gray-300 py-3 rounded items-center mx-8 mt-3"
                >
                  <Text className="text-black text-xl">Entrar como invitado</Text>
                </TouchableOpacity>
